...
def solution(k, ranges):
    ...
    def ifuc(ran,n):
        if ran[0]>ran[1]+n:
            ...
            return integral[ran[1]+n] - integral[ran[0]]
        
    answer = []
    l = len(integral)-1
    for ran in ranges:
        answer.append(ifuc(ran,l))
    return answer

# 테스트 1 〉	통과 (0.01ms, 10.1MB)
# 테스트 2 〉	통과 (0.15ms, 10.3MB)
# 테스트 3 〉	통과 (2.46ms, 12.3MB)
# 테스트 4 〉	통과 (0.43ms, 10.5MB)
# 테스트 5 〉	통과 (0.21ms, 10.2MB)
# 테스트 6 〉	통과 (0.75ms, 10.5MB)
# 테스트 7 〉	통과 (3.08ms, 12.2MB)
# 테스트 8 〉	통과 (2.79ms, 12.3MB)
# 테스트 9 〉	통과 (0.07ms, 10.2MB)
# 테스트 10 〉	통과 (0.98ms, 10.8MB)

## 다른 사람 풀이. 내 풀이가 최고다! 이 풀이는 루프를 1번 더 돌아서 시간이 좀 더 걸린다.
def solution(k, ranges):
    answer = []
    arr = [k]
    while k > 1:
...
# 테스트 2 〉	통과 (0.23ms, 10MB)
# 테스트 3 〉	통과 (3.96ms, 12.4MB)
# 테스트 4 〉	통과 (0.56ms, 10.4MB)
# 테스트 5 〉	통과 (0.27ms, 10.1MB)
# 테스트 6 〉	통과 (1.14ms, 10.6MB)
# 테스트 7 〉	통과 (3.52ms, 12MB)
# 테스트 8 〉	통과 (3.71ms, 12.3MB)
# 테스트 9 〉	통과 (0.11ms, 10.1MB)
# 테스트 10 〉	통과 (1.51ms, 10.7MB)